...
file_path = '/kyukon/data/gent/vo/000/gvo00041/vsc46127/AHF/AHF_world.nc'
ds =xr.open_dataset(file_path)

# Function to replace "tas_" with "AHF" and remove the "_UrbClim_2015_09_v1.0" part
def modify_variable_string(input_string):
    modified_string = input_string.replace('tas_', 'AHF_')
...
output_directory = '/kyukon/data/gent/vo/000/gvo00041/vsc46127/AHF'
