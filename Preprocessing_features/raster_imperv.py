...
file_path = '/kyukon/data/gent/vo/000/gvo00041/vsc46127/imperv/IMD_2015_100m_eu.tif'
ds = rxr.open_rasterio(file_path, parse_coordinates=True, masked=True)


# Function to replace "tas_" with "imperv" and remove the "_UrbClim_2015_09_v1.0" part
def modify_variable_string(input_string):
    modified_string = input_string.replace('tas_', 'imperv_')
...
output_directory = '/kyukon/data/gent/vo/000/gvo00041/vsc46127/imperv'
