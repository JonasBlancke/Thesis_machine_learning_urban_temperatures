...
val = pd.read_csv(file_path, usecols=['T_2M', 'city','T_TARGET','T_2M_COR', 'LC_CORINE', 'IMPERV', 'HEIGHT', 'BUILT_FRAC', 'COAST', 'ELEV', 'POP', 'AHF','NDVI', 'T_SK', 'SM', 'RH', 'SP', 'PRECIP', 'WS', 'WD', 'U10', 'V10', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'SOLAR_ELEV', 'DECL'])
...
X_val = val[['LC_CORINE', 'IMPERV', 'HEIGHT', 'BUILT_FRAC', 'COAST', 'ELEV', 'POP', 'AHF','NDVI', 'SKT', 'SM', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'WD', 'U10', 'V10', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'SOLAR_ELEV', 'DECL']]
import matplotlib.pyplot as plt
import pandas as pd
import joblib
...
spatial_feat = ['LC_CORINE', 'IMPERV', 'HEIGHT', 'BUILT_FRAC', 'COAST', 'ELEV', 'POP', 'AHF']

# Load the model
model = joblib.load("/kyukon/data/gent/vo/000/gvo00041/vsc46127/FEATURESEL/model_CORINE_REEEEL.joblib")
...
# Save the figure
plt.savefig('/kyukon/data/gent/vo/000/gvo00041/vsc46127/feature_importance_CORINE.png')
...
general_indices.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/evaluation_results_ERA5_CORRECTED_general_CORINE.csv", index=False)
...
# Save the DataFrame to a CSV file
general_indices.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/evaluation_results_ERA5_NONCORRECTED_general_CORINE.csv", index=False)
...
# Save the DataFrame to a CSV file
general_indices.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/evaluation_results_CORINE_general.csv", index=False)
...
for city in cities:
    ...
    X_val_city=city_val[['LC_CORINE', 'IMPERV', 'HEIGHT', 'BUILT_FRAC', 'COAST', 'ELEV', 'POP', 'AHF','NDVI', 'SKT', 'SM', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'WD', 'U10', 'V10', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'SOLAR_ELEV', 'DECL']]
...
evaluation_df.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/evaluation_results_CORINE_percity.csv")
...
fig.savefig('/kyukon/data/gent/vo/000/gvo00041/vsc46127/CORINE_permutation_importance_plot.png')
