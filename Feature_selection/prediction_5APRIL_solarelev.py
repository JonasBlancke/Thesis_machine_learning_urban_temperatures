...
val = pd.read_csv(file_path, usecols=[ 'city','T_TARGET','T_2M_COR', 'LC_CORINE', 'IMPERV', 'HEIGHT',  'COAST', 'ELEV', 'POP','NDVI', 'T_SK', 'SM', 'RH', 'SP', 'PRECIP', 'WS', 'WD', 'TCC', 'CBH', 'CAPE', 'BLH', 'SOLAR_ELEV', 'DECL'])

file_path = '/kyukon/data/gent/vo/000/gvo00041/vsc46127/train_data_FINAL.csv'
train = pd.read_csv(file_path, usecols=['city','T_TARGET','T_2M_COR','LC_CORINE',  'IMPERV', 'HEIGHT',  'COAST', 'ELEV', 'POP', 'NDVI', 'T_SK', 'SM', 'RH', 'SP', 'PRECIP', 'WS', 'WD', 'TCC', 'CBH', 'CAPE', 'BLH', 'SOLAR_ELEV', 'DECL'])
...
train = train[['LC_CORINE', 'IMPERV', 'HEIGHT', 'COAST', 'ELEV', 'POP','NDVI', 'SKT', 'SM', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'WD',  'TCC', 'CBH', 'CAPE', 'BLH',  'SOLAR_ELEV', 'DECL']]

y_val = val['T2M_difference'] 
val = val[['LC_CORINE', 'IMPERV', 'HEIGHT', 'COAST', 'ELEV', 'POP', 'NDVI', 'SKT', 'SM', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'WD', 'TCC', 'CBH', 'CAPE', 'BLH',  'SOLAR_ELEV', 'DECL']]
...
elapsed_time = end_time - start_time
with open('run_time.txt', 'a') as f:
    f.write(f"Elapsed time model WS+WD: {elapsed_time} seconds and rmse val score of {rmse_val} and rmse train score of {rmse_train} \n")
...
joblib.dump(rf, "/kyukon/data/gent/vo/000/gvo00041/vsc46127/FEATURESEL/model_solarelev.joblib")
