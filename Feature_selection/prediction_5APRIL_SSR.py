...
val = pd.read_csv(file_path, usecols=[ 'city','T_TARGET','T_2M_COR', 'LC_CORINE', 'IMPERV', 'HEIGHT',  'COAST', 'ELEV', 'POP','NDVI', 'T_SK', 'SM', 'RH', 'SP', 'PRECIP', 'WS', 'WD', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'DECL'])

file_path = '/kyukon/data/gent/vo/000/gvo00041/vsc46127/train_data_FINAL.csv'
train = pd.read_csv(file_path, usecols=['city','T_TARGET','T_2M_COR','LC_CORINE',  'IMPERV', 'HEIGHT',  'COAST', 'ELEV', 'POP', 'NDVI', 'T_SK', 'SM', 'RH', 'SP', 'PRECIP', 'WS', 'WD', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'DECL'])
...
train = train[['LC_CORINE', 'IMPERV', 'HEIGHT', 'COAST', 'ELEV', 'POP','NDVI', 'SKT', 'SM', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'WD',  'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'DECL']]

y_val = val['T2M_difference'] 
val = val[['LC_CORINE', 'IMPERV', 'HEIGHT', 'COAST', 'ELEV', 'POP', 'NDVI', 'SKT', 'SM', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'WD', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'DECL']]
...
joblib.dump(rf, "/kyukon/data/gent/vo/000/gvo00041/vsc46127/FEATURESEL/model_SSR.joblib")
