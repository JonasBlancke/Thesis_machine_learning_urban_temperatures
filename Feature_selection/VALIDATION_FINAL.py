...
general_indices.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/evaluation_results_ERA5_CORRECTED_general_FINAL.csv", index=False)
...
# Save the DataFrame to a CSV file
general_indices.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/evaluation_results_ERA5_NONCORRECTED_general_FINAL.csv", index=False)
...
# Save the DataFrame to a CSV file
general_indices.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/evaluation_results_FINAL_general.csv", index=False)
...
evaluation_df.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/evaluation_results_FINAL_percity.csv")
...
# Save the figure
plt.savefig('/kyukon/data/gent/vo/000/gvo00041/vsc46127/feature_importance_FINAL.png')
...
fig.savefig('/kyukon/data/gent/vo/000/gvo00041/vsc46127/FINAL_permutation_importance_plot.png')
