...
df = pd.read_csv(file_path, usecols=['T_2M_COR', 'T_SK', 'T_TARGET', 'city', 'hour','NDVI', 'SM', 'RH', 'SP', 'PRECIP', 'WS', 'WD', 'U10', 'V10', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'SOLAR_ELEV', 'DECL'])
...
variables_of_interest = ['NDVI', 'SKT', 'SM', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'WD', 'U10', 'V10', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'SOLAR_ELEV', 'DECL']
...
plt.title('Correlation of the temporal candidate features with the target variable: T2M_difference', fontsize=22)
plt.ylabel('Correlation', fontsize=18)
plt.xticks(ticks=x, labels=variables_of_interest, rotation=45, ha='right', fontsize=16)
plt.legend(fontsize=14)
plt.tight_layout()
plt.savefig('correlation_with_t2m_difference_temporal.png', format='png')
plt.show()
