...
def process_city_data(city, year, month):
    ...
    output_path = f'/kyukon/data/gent/vo/000/gvo00041/vsc46127/train_test/MODEL_PART1_TEST_NO_SPSUB/ready_for_model_{city}_{year}_{month}.csv'
