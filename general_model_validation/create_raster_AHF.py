...
X_test = city_data[['LC_CORINE', 'IMPERV', 'HEIGHT', 'BUILT_FRAC', 'COAST', 'ELEV', 'POP', 'AHF','NDVI', 'SKT', 'SM', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'WD', 'U10', 'V10', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'SOLAR_ELEV', 'DECL']]
...
plt.tight_layout()
plt.savefig(f'UrbClim_T2m_AHF_{city}_{years}_{days}_{months}_{hours}.png', format='png')
plt.close()
...
mappable_pred.colorbar.set_label(f'T2M [{celcius}]', size=16)
plt.tight_layout()
plt.savefig(f'RFmodel_T2m_AHF_{city}_{years}_{days}_{months}_{hours}.png', format='png')
plt.close()
