...
test = pd.read_csv('/kyukon/data/gent/vo/000/gvo00041/vsc46127/train_test/CITIES3/ready_for_model_Brussels_2017_06.csv')
...
mean_T2M_pred_Brussels.to_csv('mean_T2M_pred_Brussels06.csv', header=True)

mean_T2M_UrbClim_Brussels.to_csv('mean_T2M_UrbClim_Brussels06.csv', header=True)

mean_T2M_diff_pred_Brussels.to_csv('mean_T2M_diff_pred_Brussels06.csv', header=True)

mean_T2M_diff_UrbClim_Brussels.to_csv('mean_mean_T2M_diff_UrbClim_Brussels06.csv', header=True)

mean_T2M_ERA5_Brussels.to_csv('mean_T2M_ERA5_Brussels06.csv', header=True)
