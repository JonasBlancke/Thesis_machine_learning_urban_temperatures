...
data = pd.read_csv('/kyukon/data/gent/vo/000/gvo00041/vsc46127/cluster/cities_train_FINAL.csv')
...
subsample.to_csv('/kyukon/data/gent/vo/000/gvo00041/vsc46127/CLUSTER1_TRAIN_cities.csv', index=False)


# Save subsamples for all cities
subsample = df[df['city'].isin(selected_cities2)]
subsample.to_csv('/kyukon/data/gent/vo/000/gvo00041/vsc46127/CLUSTER2_TRAIN_cities.csv', index=False)

# Save subsamples for all cities
subsample = df[df['city'].isin(selected_cities3)]
subsample.to_csv('/kyukon/data/gent/vo/000/gvo00041/vsc46127/CLUSTER3_TRAIN_cities.csv', index=False)
