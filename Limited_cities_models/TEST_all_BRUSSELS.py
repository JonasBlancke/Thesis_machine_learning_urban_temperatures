...
val = pd.read_csv(file_path, usecols=['T_2M', 'city','T_TARGET','T_2M_COR', 'LC_CORINE', 'IMPERV', 'HEIGHT','COAST', 'ELEV', 'POP',  'RH', 'SP', 'PRECIP', 'WS', 'TCC', 'CBH', 'CAPE', 'BLH', 'SSR', 'SOLAR_ELEV', 'DECL'])
...
# Load the model
model = joblib.load("/kyukon/data/gent/vo/000/gvo00041/vsc46127/PART2/model_BRUSSELS.joblib")
...
# Save the figure
plt.savefig('/kyukon/data/gent/vo/000/gvo00041/vsc46127/feature_importance_BRUSSELS.png')
...
general_indices.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/BRUSSELS_evaluation_results_ERA5_CORRECTED_general_ALL.csv", index=False)
...
# Save the DataFrame to a CSV file
general_indices.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/BRUSSELS_evaluation_results_ERA5_NONCORRECTED_general_ALL.csv", index=False)
...
# Save the DataFrame to a CSV file
general_indices.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/BRUSSELS_evaluation_results_ALL_general.csv", index=False)
...
for city in cities:
    ...
    X_val_city=city_val[['LC_CORINE', 'IMPERV', 'HEIGHT', 'COAST', 'ELEV', 'POP', 'RH', 'SP', 'PRECIP','T2M', 'WS', 'TCC', 'CAPE', 'BLH', 'SSR', 'SOLAR_ELEV', 'DECL']]
...
evaluation_df.to_csv("/kyukon/data/gent/vo/000/gvo00041/vsc46127/BRUSSELS_evaluation_results_ALL_percity.csv")
