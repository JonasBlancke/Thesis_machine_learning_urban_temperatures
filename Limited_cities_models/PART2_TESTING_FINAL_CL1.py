...
general_indices.to_csv(f"/kyukon/data/gent/vo/000/gvo00041/vsc46127/PART2/CLUSTER1/CL1_GENERAL_{experiment}.csv", index=False)
...
evaluation_df.to_csv(f"/kyukon/data/gent/vo/000/gvo00041/vsc46127/PART2/CLUSTER1/CL1_percity_{experiment}.csv")
